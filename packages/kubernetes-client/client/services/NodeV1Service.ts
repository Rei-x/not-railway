...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_node_v1_RuntimeClass } from '../models/io_k8s_api_node_v1_RuntimeClass';
import type { io_k8s_api_node_v1_RuntimeClassList } from '../models/io_k8s_api_node_v1_RuntimeClassList';
...
export class NodeV1Service {
     ...
     * @throws ApiError
     */
    public getNodeV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_node_v1_RuntimeClassList OK
     * @throws ApiError
     */
    public listNodeV1RuntimeClass({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_node_v1_RuntimeClassList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_api_node_v1_RuntimeClass OK
     * @throws ApiError
     */
    public createNodeV1RuntimeClass({
        ...
        body: io_k8s_api_node_v1_RuntimeClass,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_node_v1_RuntimeClass> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/node.k8s.io/v1/runtimeclasses',
            query: {
