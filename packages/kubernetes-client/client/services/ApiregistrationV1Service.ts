...
import type { io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIService } from '../models/io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIService';
import type { io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIServiceList } from '../models/io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIServiceList';

import type { CancelablePromise } from '../core/CancelablePromise';
import type { BaseHttpRequest } from '../core/BaseHttpRequest';

export class ApiregistrationV1Service {
     ...
     * @throws ApiError
     */
    public getApiregistrationV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIServiceList OK
     * @throws ApiError
     */
    public listApiregistrationV1ApiService({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIServiceList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIService OK
     * @throws ApiError
     */
    public createApiregistrationV1ApiService({
        ...
        body: io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIService,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_APIService> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/apiregistration.k8s.io/v1/apiservices',
            query: {
