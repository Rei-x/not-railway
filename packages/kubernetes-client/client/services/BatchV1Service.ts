...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_batch_v1_CronJob } from '../models/io_k8s_api_batch_v1_CronJob';
import type { io_k8s_api_batch_v1_CronJobList } from '../models/io_k8s_api_batch_v1_CronJobList';
import type { io_k8s_api_batch_v1_Job } from '../models/io_k8s_api_batch_v1_Job';
import type { io_k8s_api_batch_v1_JobList } from '../models/io_k8s_api_batch_v1_JobList';
...
export class BatchV1Service {
     ...
     * @throws ApiError
     */
    public getBatchV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_batch_v1_CronJobList OK
     * @throws ApiError
     */
    public listBatchV1CronJobForAllNamespaces({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_batch_v1_CronJobList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_api_batch_v1_JobList OK
     * @throws ApiError
     */
    public listBatchV1JobForAllNamespaces({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_batch_v1_JobList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    /**
     * create a CronJob
     * @returns io_k8s_api_batch_v1_CronJob OK
     * @throws ApiError
     */
    public createBatchV1NamespacedCronJob({
         ...
         */
        namespace: string,
        body: io_k8s_api_batch_v1_CronJob,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_batch_v1_CronJob> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/batch/v1/namespaces/{namespace}/cronjobs',
            path: {
    ...
    /**
     * create a Job
     * @returns io_k8s_api_batch_v1_Job OK
     * @throws ApiError
     */
    public createBatchV1NamespacedJob({
         ...
         */
        fieldValidation?: string,
    }): CancelablePromise<io_k8s_api_batch_v1_Job> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/batch/v1/namespaces/{namespace}/jobs',
            path: {
