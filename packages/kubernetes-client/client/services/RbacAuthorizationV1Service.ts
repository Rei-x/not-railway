...
export class RbacAuthorizationV1Service {
     ...
     * @throws ApiError
     */
    public getRbacAuthorizationV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
    ...
    public listRbacAuthorizationV1ClusterRoleBinding({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_rbac_v1_ClusterRoleBindingList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    }): CancelablePromise<io_k8s_api_rbac_v1_ClusterRoleBinding> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/rbac.authorization.k8s.io/v1/clusterrolebindings',
            query: {
    ...
    public listRbacAuthorizationV1ClusterRole({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_rbac_v1_ClusterRoleList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    public createRbacAuthorizationV1ClusterRole({
         ...
         */
        fieldValidation?: string,
    }): CancelablePromise<io_k8s_api_rbac_v1_ClusterRole> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/rbac.authorization.k8s.io/v1/clusterroles',
            query: {
    ...
    public listRbacAuthorizationV1NamespacedRoleBinding({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_rbac_v1_RoleBindingList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    public createRbacAuthorizationV1NamespacedRoleBinding({
         ...
         */
        fieldValidation?: string,
    }): CancelablePromise<io_k8s_api_rbac_v1_RoleBinding> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings',
            path: {
    ...
    public listRbacAuthorizationV1NamespacedRole({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_rbac_v1_RoleList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    public createRbacAuthorizationV1NamespacedRole({
         ...
         */
        fieldValidation?: string,
    }): CancelablePromise<io_k8s_api_rbac_v1_Role> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles',
            path: {
