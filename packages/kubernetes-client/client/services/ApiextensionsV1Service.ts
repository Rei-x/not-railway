...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinition } from '../models/io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinition';
import type { io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinitionList } from '../models/io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinitionList';
...
export class ApiextensionsV1Service {
     ...
     * @throws ApiError
     */
    public getApiextensionsV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinitionList OK
     * @throws ApiError
     */
    public listApiextensionsV1CustomResourceDefinition({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinitionList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinition OK
     * @throws ApiError
     */
    public createApiextensionsV1CustomResourceDefinition({
        ...
        body: io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinition,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_CustomResourceDefinition> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/apiextensions.k8s.io/v1/customresourcedefinitions',
            query: {
