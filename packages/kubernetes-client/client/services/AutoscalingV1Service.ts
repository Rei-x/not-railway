...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_autoscaling_v1_HorizontalPodAutoscaler } from '../models/io_k8s_api_autoscaling_v1_HorizontalPodAutoscaler';
import type { io_k8s_api_autoscaling_v1_HorizontalPodAutoscalerList } from '../models/io_k8s_api_autoscaling_v1_HorizontalPodAutoscalerList';
...
export class AutoscalingV1Service {
     ...
     * @throws ApiError
     */
    public getAutoscalingV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_autoscaling_v1_HorizontalPodAutoscalerList OK
     * @throws ApiError
     */
    public listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_autoscaling_v1_HorizontalPodAutoscalerList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_api_autoscaling_v1_HorizontalPodAutoscaler OK
     * @throws ApiError
     */
    public createAutoscalingV1NamespacedHorizontalPodAutoscaler({
         ...
         */
        namespace: string,
        body: io_k8s_api_autoscaling_v1_HorizontalPodAutoscaler,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_autoscaling_v1_HorizontalPodAutoscaler> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers',
            path: {
