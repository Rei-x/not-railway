...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_scheduling_v1_PriorityClass } from '../models/io_k8s_api_scheduling_v1_PriorityClass';
import type { io_k8s_api_scheduling_v1_PriorityClassList } from '../models/io_k8s_api_scheduling_v1_PriorityClassList';
...
export class SchedulingV1Service {
     ...
     * @throws ApiError
     */
    public getSchedulingV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_scheduling_v1_PriorityClassList OK
     * @throws ApiError
     */
    public listSchedulingV1PriorityClass({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_scheduling_v1_PriorityClassList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_api_scheduling_v1_PriorityClass OK
     * @throws ApiError
     */
    public createSchedulingV1PriorityClass({
        ...
        body: io_k8s_api_scheduling_v1_PriorityClass,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_scheduling_v1_PriorityClass> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/scheduling.k8s.io/v1/priorityclasses',
            query: {
