...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_storage_v1beta1_CSIStorageCapacity } from '../models/io_k8s_api_storage_v1beta1_CSIStorageCapacity';
import type { io_k8s_api_storage_v1beta1_CSIStorageCapacityList } from '../models/io_k8s_api_storage_v1beta1_CSIStorageCapacityList';
...
export class StorageV1Beta1Service {
     ...
     * @throws ApiError
     */
    public getStorageV1Beta1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_storage_v1beta1_CSIStorageCapacityList OK
     * @throws ApiError
     */
    public listStorageV1Beta1CsiStorageCapacityForAllNamespaces({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_storage_v1beta1_CSIStorageCapacityList> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/apis/storage.k8s.io/v1beta1/csistoragecapacities',
            query: {
    ...
    public listStorageV1Beta1NamespacedCsiStorageCapacity({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities',
            path: {
                'namespace': namespace,
            },
            query: {
     ...
     * @returns io_k8s_api_storage_v1beta1_CSIStorageCapacity OK
     * @throws ApiError
     */
    public createStorageV1Beta1NamespacedCsiStorageCapacity({
         ...
         */
        namespace: string,
        body: io_k8s_api_storage_v1beta1_CSIStorageCapacity,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_storage_v1beta1_CSIStorageCapacity> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities',
            path: {
    ...
    public readStorageV1Beta1NamespacedCsiStorageCapacity({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}',
            path: {
                'name': name,
                'namespace': namespace,
            },
    ...
    public watchStorageV1Beta1CsiStorageCapacityListForAllNamespaces({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/apis/storage.k8s.io/v1beta1/watch/csistoragecapacities',
            query: {
                'allowWatchBookmarks': allowWatchBookmarks,
                'continue': _continue,
                'fieldSelector': fieldSelector,
    ...
    public watchStorageV1Beta1NamespacedCsiStorageCapacityList({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/apis/storage.k8s.io/v1beta1/watch/namespaces/{namespace}/csistoragecapacities',
            path: {
                'namespace': namespace,
            },
            query: {
    ...
    public watchStorageV1Beta1NamespacedCsiStorageCapacity({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/apis/storage.k8s.io/v1beta1/watch/namespaces/{namespace}/csistoragecapacities/{name}',
            path: {
                'name': name,
                'namespace': namespace,
            },
