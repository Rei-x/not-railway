...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_coordination_v1_Lease } from '../models/io_k8s_api_coordination_v1_Lease';
import type { io_k8s_api_coordination_v1_LeaseList } from '../models/io_k8s_api_coordination_v1_LeaseList';
...
export class CoordinationV1Service {
     ...
     * @throws ApiError
     */
    public getCoordinationV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_coordination_v1_LeaseList OK
     * @throws ApiError
     */
    public listCoordinationV1LeaseForAllNamespaces({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_coordination_v1_LeaseList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    /**
     * create a Lease
     * @returns io_k8s_api_coordination_v1_Lease OK
     * @throws ApiError
     */
    public createCoordinationV1NamespacedLease({
         ...
         */
        namespace: string,
        body: io_k8s_api_coordination_v1_Lease,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_coordination_v1_Lease> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases',
            path: {
