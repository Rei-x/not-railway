...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_events_v1_Event } from '../models/io_k8s_api_events_v1_Event';
import type { io_k8s_api_events_v1_EventList } from '../models/io_k8s_api_events_v1_EventList';
...
export class EventsV1Service {
     ...
     * @throws ApiError
     */
    public getEventsV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_events_v1_EventList OK
     * @throws ApiError
     */
    public listEventsV1EventForAllNamespaces({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_events_v1_EventList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    /**
     * create an Event
     * @returns io_k8s_api_events_v1_Event OK
     * @throws ApiError
     */
    public createEventsV1NamespacedEvent({
         ...
         */
        namespace: string,
        body: io_k8s_api_events_v1_Event,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_events_v1_Event> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/events.k8s.io/v1/namespaces/{namespace}/events',
            path: {
