...
export class CertificatesV1Service {
     ...
     * @throws ApiError
     */
    public getCertificatesV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
    ...
    public listCertificatesV1CertificateSigningRequest({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_certificates_v1_CertificateSigningRequestList> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    }): CancelablePromise<io_k8s_api_certificates_v1_CertificateSigningRequest> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/certificates.k8s.io/v1/certificatesigningrequests',
            query: {
