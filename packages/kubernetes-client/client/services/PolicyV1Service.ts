...
/* tslint:disable */
/* eslint-disable */
import type { io_k8s_api_policy_v1_PodDisruptionBudget } from '../models/io_k8s_api_policy_v1_PodDisruptionBudget';
import type { io_k8s_api_policy_v1_PodDisruptionBudgetList } from '../models/io_k8s_api_policy_v1_PodDisruptionBudgetList';
...
export class PolicyV1Service {
     ...
     * @throws ApiError
     */
    public getPolicyV1ApiResources(): CancelablePromise<io_k8s_apimachinery_pkg_apis_meta_v1_APIResourceList> {
     ...
     * @returns io_k8s_api_policy_v1_PodDisruptionBudgetList OK
     * @throws ApiError
     */
    public listPolicyV1NamespacedPodDisruptionBudget({
         ...
         */
        watch?: boolean,
    }): CancelablePromise<io_k8s_api_policy_v1_PodDisruptionBudgetList> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @returns io_k8s_api_policy_v1_PodDisruptionBudget OK
     * @throws ApiError
     */
    public createPolicyV1NamespacedPodDisruptionBudget({
         ...
         */
        namespace: string,
        body: io_k8s_api_policy_v1_PodDisruptionBudget,
        /**
         * If 'true', then the output is pretty printed.
         */
        pretty?: string,
    ...
    }): CancelablePromise<io_k8s_api_policy_v1_PodDisruptionBudget> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets',
            path: {
