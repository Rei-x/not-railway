 ...
 */
export type io_cilium_v2_CiliumClusterwideNetworkPolicy = {
    /**
    ...
    spec?: {
        ...
        egress?: Array<{
             ...
             */
            toEntities?: Array<'all' | 'world' | 'cluster' | 'host' | 'init' | 'ingress' | 'unmanaged' | 'remote-node' | 'health' | 'none' | 'kube-apiserver'>;
            /**
        ...
        ingress?: Array<{
             ...
             */
            fromEntities?: Array<'all' | 'world' | 'cluster' | 'host' | 'init' | 'ingress' | 'unmanaged' | 'remote-node' | 'health' | 'none' | 'kube-apiserver'>;
            /**
